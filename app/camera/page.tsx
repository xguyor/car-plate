      ...
      <div className="p-4 max-w-md mx-auto">
          ...
          <div className="mt-4 bg-green-500/20 border border-green-500/30 p-4 rounded-xl">
            ...
            {ownerInfo && (
              <div className="bg-white/10 rounded-xl p-4 space-y-3">
                <p className="text-white font-medium text-center">Blocking car owner notified!</p>
                <p className="text-purple-300 text-sm text-center">They will receive a notification to move their car</p>
                {ownerInfo.name && (
        ...
        {plate && !success && (
          ...
          >
            ...
            {sending ? 'Notifying...' : isRegistered ? 'Notify Blocking Car' : 'Notify (Register First)'}
          </button>
        )}
