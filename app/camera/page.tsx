                ...
                <div>
                  ...
                  {alert.sender_phone && (
                    <div className="flex items-center gap-3 mt-1">
                      <a href={`tel:${alert.sender_phone}`} className="text-purple-300 text-sm flex items-center gap-1">
                      ...
                      <a
                        href={`https://wa.me/${alert.sender_phone.replace(/\D/g, '').replace(/^0/, '972')}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="bg-green-500 hover:bg-green-400 text-white px-2 py-1 rounded-lg text-xs font-medium flex items-center gap-1"
                      >
              ...
              <div className="flex items-center justify-between mb-3">
                <div>
                  ...
                  {alert.receiver_phone && (
                    <div className="flex items-center gap-3 mt-1">
                      <a href={`tel:${alert.receiver_phone}`} className={`text-sm flex items-center gap-1 ${
                        alert.status === 'leaving_now' ? 'text-red-300 font-bold'
                        : alert.status === 'leaving_soon' ? 'text-orange-300'
                        : 'text-purple-300'
                      }`}>
                      ...
                      <a
                        href={`https://wa.me/${alert.receiver_phone.replace(/\D/g, '').replace(/^0/, '972')}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="bg-green-500 hover:bg-green-400 text-white px-2 py-1 rounded-lg text-xs font-medium flex items-center gap-1"
                      >
